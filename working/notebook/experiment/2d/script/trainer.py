...
from .dataset import (generate_dataloader, generate_valid_label,
                      get_train_valid_dataset)
from .loss import bce_dice_loss, bce_loss, dice_loss
...
def train_and_evaluate(preprocess, cfg, label_prefix="inklabels"):
    for fold_i, fold in enumerate(glob(f"{cfg.train_dataset_path}/*")):
        ...
        train_images, train_labels, train_masks, valid_images, valid_labels, valid_xyxys = get_train_valid_dataset(valid_fragment_i, valid_split_i, cfg, preprocess, label_prefix)
        ...
        for epoch in range(cfg.epochs):
            ...
            if update_best:  # type: ignore
                ...
                torch.save({'model': model.state_dict(),
                           ...
                           model_path)
            print()
        del model, optimizer, scheduler, loss_fn, device
